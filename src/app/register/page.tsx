      ...
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          <Link href="/" className="inline-block">
            <h1 className="text-2xl font-bold text-slate-800 mb-2">Luxembourg Real Estate</h1>
          </Link>
          <p className="text-slate-600">Create your account to start your property search</p>
        </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="space-y-3">
                ...
                <label className="flex items-start">
                  ...
                  />
                  <span className="ml-2 text-sm text-slate-600">
                    I would like to receive marketing emails about new properties and updates
                  </span>
                </label>
              </div>
